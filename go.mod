...
replace github.com/ipfs/go-merkledag => github.com/hinshun/go-merkledag v0.1.1-0.20190910230203-e089ed59ddef

replace github.com/ipfs/go-blockservice => github.com/hinshun/go-blockservice v0.1.3-0.20190906224057-ac48d5e10ef6

replace github.com/ipfs/go-bitswap => github.com/hinshun/go-bitswap v0.1.7-0.20190910225808-7fcd21c1cfef
